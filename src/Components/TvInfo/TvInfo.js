...
const TvInfo = (props) => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            let urlMovie = `https://api.themoviedb.org/3/tv/${props.tvId}?api_key=4cc894b01eadfbbfbff1135572164973&language=en-US&append_to_response=videos,credits,similar,external_ids`;
...
`,
                            ...
                            <div className="all-movie-details">
                                ...
                                <article className="details-main">
                                    <div className="rating">
                                        <h3 className="heading">Temporadas</h3>
                                        <div className="tags">
                                            <Link
                                                to={`./../season/${props.tvId}/${tvInfo.name}/${tvInfo.number_of_seasons}`}
                                                className="season-link"
            ...
            {!isValidTv && <NotFound message="Nenhum programa de TV encontrado!" />}
