            ...
            <div className="header">
                <Link to="/" className="logo-position">
                   ...
                   <img src={logo} alt="Logo" />
                            ...
                            <g
                                aria-label="DWFilmes Entreterimentos"
                                style={{
                                    lineHeight: 1.25
                                }}
                                fontWeight={400}
                    ...
                    <section className="user-sec">
                        <Link to="./../register">
                            <h1
                                ...
                                aria-label="INSCREVER-SE button"
                            >
                                INSCREVER-SE
                            </h1>
                        </Link>
                    ...
                    <Menu key="menu" className="menu general-menu">
                        <div className="menu-wrap">
                            <ul className="menu-main">
                                ...
                                >
                                    <li>
                                        <h1 className="menu-item">Inicio</h1>
                                    </li>
                                </Link>
                                <Link
                                    to="./../movie"
                                ...
                                >
                                    <li>
                                        <h1 className="menu-item">Filmes</h1>
                                    </li>
                                </Link>
                                <Link
                                    to="./../tv"
                                ...
                                >
                                    <li>
                                        <h1 className="menu-item">TV-Series</h1>
                                    </li>
                                </Link>
                                <Link
                                    to="./../search"
                                ...
                                >
                                    <li>
                                        <h1 className="menu-item">Buscar</h1>
                                    </li>
                                </Link>
                                {!isLoggedIn && (
                                    <Link
                                    ...
                                    >
                                        <li>
                                            <h1 className="menu-item">Entrar</h1>
                                        </li>
                                    </Link>
                                )}
                                {!isLoggedIn && (
