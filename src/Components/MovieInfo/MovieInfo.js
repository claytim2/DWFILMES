...
const MovieInfo = (props) => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            let urlMovie = `https://api.themoviedb.org/3/movie/${props.movieId}?api_key=4cc894b01eadfbbfbff1135572164973&language=en-US&append_to_response=videos,credits,similar`;
...
`,
                            ...
                            <div className="all-movie-details">
                                ...
                                <article className="details-main">
                                    <div className="rating">
                                        <h3 className="heading">Avaliação</h3>
                                        <div className="tags">
                                    ...
                                    <div className="genres">
                                        <h3 className="heading">Gêneros</h3>
                                        <div className="tags">
                                    ...
                                    <div className="language">
                                        <h3 className="heading">Língua</h3>
                                        <div className="tags">
                                            <div className="genre__tag">
                                    ...
                                    <div className="runtime">
                                        <h3 className="heading">Tempo de execução</h3>
                                        <div className="tags">
                                            <div className="genre__tag">
                                                {movieInfo.runtime ===
                                                    undefined ||
                                    ...
                                    <div className="budget">
                                        <h3 className="heading">Despesas</h3>
                                        <div className="tags">
                                            <div className="genre__tag">
                                                {`${numberToBoxOffice(
                                                    movieInfo.budget
                                    ...
                                    <div className="box-office">
                                        <h3 className="heading">Bilheteria</h3>
                                        <div className="tags">
                                            <div className="genre__tag">
                                                {`${numberToBoxOffice(
                                                    movieInfo.revenue
            ...
            {!isValidMovie && <NotFound message="Nenhum filme encontrado!" />}
